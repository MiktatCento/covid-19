import 'package:covid19/views/turkiye.dart';
...
class _DashboardState extends State<Dashboard> with TickerProviderStateMixin {
  int currentIndex = 0;
  final List<Widget> children = [World(), Turkiye(), Country()];
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
              ...
              title: Text("Türkiye", style: TextStyle(fontFamily: 'MyFont'))),
          BottomNavigationBarItem(
              icon: Icon(Icons.flag),
              title: Text("Diğer Ülkeler",
                  style: TextStyle(fontFamily: 'MyFont'))),
        ],
      ),
      body: currentIndex == 0
